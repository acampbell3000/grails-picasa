						...
						<table>
							<thead>
								<tr>
                                    ...
                                    <g:remoteSortableColumn action="ajaxList" update="listPhoto" property="title" title="${message(code: 'uk.co.anthonycampbell.grails.plugins.picasa.Photo.title.label', default: 'Title')}" />

                                    <g:remoteSortableColumn action="ajaxList" update="listPhoto" property="description" title="${message(code: 'uk.co.anthonycampbell.grails.plugins.picasa.Photo.description.label', default: 'Description')}" />

                                    <th><g:message code="uk.co.anthonycampbell.grails.plugins.picasa.Photo.image.label" default="Image" /></th>

                                    <g:remoteSortableColumn action="ajaxList" update="listPhoto" property="cameraModel" title="${message(code: 'uk.co.anthonycampbell.grails.plugins.picasa.Photo.cameraModel.label', default: 'Camera Model')}" />

                                    <th><g:message code="uk.co.anthonycampbell.grails.plugins.picasa.Photo.geoLocation.label" default="Geo Location" /></th>

                                    <g:remoteSortableColumn action="ajaxList" update="listPhoto" property="dateCreated" title="${message(code: 'uk.co.anthonycampbell.grails.plugins.picasa.Photo.dateCreated.label', default: 'Date Created')}" />
								</tr>
							</thead>
							<tbody>
...
>>>>>>> 2af7b034941ff97445b9b31174efbd83dd3d9e81
                            </div>
                            <div id="feeds">
