...
<html>
    <head>
        ...
        <title><g:message code="uk.co.anthonycampbell.grails.picasa.Photo.legend" default="Photo Listing" /></title>
    </head>
    <body>
				<h1><g:message code="uk.co.anthonycampbell.grails.picasa.Photo.legend" default="Photo Listing" /></h1>
					<ul id="nav">
