...
<html>
    <head>
        ...
        <title><g:message code="uk.co.anthonycampbell.grails.plugins.picasa.Tag.legend" default="Tag Listing" /></title>
    </head>
    <body>
				<h1><g:message code="uk.co.anthonycampbell.grails.plugins.picasa.Tag.legend" default="Tag Listing" /></h1>
					<ul id="nav">
