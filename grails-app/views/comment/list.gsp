...
<html>
    <head>
        ...
        <title><g:message code="uk.co.anthonycampbell.grails.plugins.picasa.Comment.legend" default="Photo Comments" /></title>
    </head>
    <body>
				<h1><g:message code="uk.co.anthonycampbell.grails.plugins.picasa.Comment.legend" default="Photo Comments" /></h1>
					<ul id="nav">
