<%@ page import="uk.co.anthonycampbell.grails.picasa.Comment"
         import="uk.co.anthonycampbell.grails.picasa.CommentController" %>
                        ...
                        <g:hasErrors bean="${commentInstance}">
                            <div id="errorMessage"><g:message code="uk.co.anthonycampbell.grails.picasa.Comment.error.post"
                            ...
                            onLoaded="displayResponse('comments')">
                                <fieldset>
                                    <legend><g:message code="uk.co.anthonycampbell.grails.picasa.Comment.label"
                                    ...
                                    <p><strong>${session.oAuthNickname}</strong> (<g:remoteLink id="commentLogout"
                                        ...
                                        url="[controller: 'comment', action: 'ajaxLogout', id: albumId + CommentController.ID_SEPARATOR + photoId]"><g:message
                                            code="uk.co.anthonycampbell.grails.picasa.oauth.logout.link"
                                            default="Logout" /></g:remoteLink>)</p>

                                    <p><label for="message"><g:message code="uk.co.anthonycampbell.grails.picasa.Comment.message.label"
                                    ...
                                    <p><input id="submit" class="button" type="submit" name="submit"
                                        value="${message(code: 'uk.co.anthonycampbell.grails.picasa.Comment.button.create', default: 'Post comment')}" />
                        ...
                        <g:else>
                            <p><g:oauthLink consumer="picasa"
                                returnTo="[controller: 'comment', action: 'login',
                                    id: albumId + CommentController.ID_SEPARATOR + photoId]">${message(code: 'uk.co.anthonycampbell.grails.picasa.oauth.login.link', default: 'Login')}</g:oauthLink>
                                ${message(code: 'uk.co.anthonycampbell.grails.picasa.oauth.login',
