         ...
         import="org.apache.commons.lang.StringUtils" %>
                          ...
                          <g:if test="${commentInstanceList != null && commentInstanceList?.size() > 0}">
                              ...
                              <div id="contentFooter">
                                  <div id="pagination">
                                      <g:remotePaginate controller="comment" action="ajaxList" update="listComment" albumId="${albumId}" photoId="${photoId}" max="${(grailsApplication.config.picasa.maxComments) ? grailsApplication.config.picasa.maxComments : 10}" maxsteps="${(grailsApplication.config.picasa.maxCommentSteps) ? grailsApplication.config.picasa.maxCommentSteps : 10}" total="${commentInstanceTotal}" />
                                  </div>
                                  <div id="feeds">
