...
<html>
    <head>
        ...
        <title><g:message code="uk.co.anthonycampbell.grails.picasa.Album.legend" default="Photo Albums" /></title>
    </head>
    <body>
				<h1><g:message code="uk.co.anthonycampbell.grails.picasa.Album.legend" default="Photo Albums" /></h1>
					<ul id="nav">
